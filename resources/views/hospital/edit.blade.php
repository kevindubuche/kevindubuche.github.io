              ...
              <form action="{{ route('hospital.update',$hospital->id) }}" method="post" role="form" >
                ...
                <div class="form-row">
                  <div class="col-md-4 form-group">
                    ...
                    <input type="text" class="form-control" required name="code_hospital" id="code_hospital"  value="{{$hospital->code_hospital}}" placeholder="Code de l'hopital" minlength="2" data-msg="Entrer au moins 2 caracteres">
                    <div class="validate"></div>
                  </div>
                 </div>
                <div class="form-row">
